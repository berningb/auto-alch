...
class GemstoneCrabAlch:
    ...
    def capture_crab_template(self):
    ...
    def detect_crab(self, screen):
        ...
        position, confidence = self.find_template_in_screen(screen, self.crab_template, threshold=0.7)
        if position:
    ...
    def save_positions(self):
        ...
        try:
            positions = {
                ...
                "crab_position": self.crab_position,
    ...
    def load_positions(self):
        ...
        try:
            if os.path.exists(self.position_file):
                ...
                self.crab_position = positions.get("crab_position")
                ...
                if self.crab_position:
                    print(f"   🦀 Crab position: {self.crab_position}")
                ...
                if current_frame is not None:
                    ...
                    if current_time - self.last_action_time >= current_cooldown:
                        ...
                        if self.waiting_for_alch_spell:
                            ...
                            # Step 5: Look for gemstone crab
                            if self.crab_position and has_saved_positions:
                                # Use remembered position
                                print(f"   🦀 Using remembered crab position: {self.crab_position}")
                                if self.click_crab(self.crab_position):
                                    self.waiting_for_alch_spell = True
                                    self.waiting_for_arrows = False
                                    self.waiting_for_crab = False
                                    self.last_action_time = current_time
